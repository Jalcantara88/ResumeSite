...
import { Card, CardImg, CardImgOverlay, CardSubtitle, CardTitle, CardBody, Button } from 'reactstrap';
...
return(
    <React.Fragment>
        ...
        <a href={project.link}>
            <div className="bg-primary text-white rounded-bottom">
                Go To Project
            </div>
...
class Portfolio extends Component {
    ...
    return (
        <div className="container-fuid bg-dark py-3" id="folio">
            <div className="row">
